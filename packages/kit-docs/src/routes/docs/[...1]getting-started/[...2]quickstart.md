...
```bash copy
npm i @svelteness/kit-docs @iconify-json/ri unplugin-icons clsx -D
```
...
KitDocs will import components in the `kit-docs` directory into every single Markdown file and
