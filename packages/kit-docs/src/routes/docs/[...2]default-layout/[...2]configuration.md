...
You can find all our default [translations on GitHub](https://github.com/svelteness/kit-docs/blob/main/packages/kit-docs/src/lib/components/layout/contexts.ts#L222).
